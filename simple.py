"""
KMEANS using Tensorflow with Input File (Simple Version)
Francesc Sastre Cabot, github: xiscosastre
Base code https://codesachin.wordpress.com/2015/11/14/k-means-clustering-with-tensorflow/
Usage example:
...
def TFKMeansCluster(vectors, num_clusters, num_steps):
    """
